...
def lambda_handler(event, context):
    ...
    stdin, stdout, stderr = ssh.exec_command(
        'cd / && sudo aws s3 cp s3://deploy-code-sentiment-analysis/ /app/sentiment-analysis --recursive && sudo aws s3 cp s3://sentiment-analysis-gz-model/ /app/sentiment-analysis --recursive')
    stdin.flush()
